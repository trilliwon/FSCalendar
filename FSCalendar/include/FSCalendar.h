...
/**
 Tells the delegate the calendar is about to detect swipe action (to left) <-
 */
- (void)calendarLeftSwipeDetected:(FSCalendar *)calendar;

/**
 Tells the delegate the calendar is about to detect swipe action (to right) ->
 */
- (void)calendarRightSwipeDetected:(FSCalendar *)calendar;
...
/**
 Return number of rows in given date month
 */
...
/**
 Check whether given date is in current calendar range
 */
